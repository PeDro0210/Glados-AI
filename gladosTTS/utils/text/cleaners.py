...
from gladosTTS.utils.text.numbers import normalize_numbers
from gladosTTS.utils.text.symbols import phonemes_set
...
class Cleaner:
    ...
    def __init__(self,
        ...
        self.lang = lang
        if use_phonemes:
            self.phonemize = Phonemizer.from_checkpoint('src\gladosTTS\models\en_us_cmudict_ipa_forward.pt')
