        ...
        if message=="Error 504ValveInteractive: I'm not in position to answear you that rigth now, inferior human, try again, someday":
            ...
            if "temperature" in message_apart:
                ...
                if formatted_datetime in request_weather['hourly']['time']:
                    ...
                    print(request_weather['hourly']['temperature_2m'][index])
                    return f"Sure human, the temperature at {formatted_datetime[11:13]} is {request_weather['hourly']['temperature_2m'][index]} degrees celsius"
                ...
                if message!="":
                    ...
                    print(f"Message from Glados is {Glados_prompt_response['choices'][0]['message']['content']}")
